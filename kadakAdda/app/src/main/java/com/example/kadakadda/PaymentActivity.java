...
public class PaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pay = (Button) findViewById(R.id.button10);
        amount = (EditText)findViewById(R.id.editTextTextPersonName7);
        note = (EditText)findViewById(R.id.editTextTextPersonName8);
        name = (EditText) findViewById(R.id.editTextTextPersonName5);
        upivirtualid =(EditText) findViewById(R.id.editTextTextPersonName6);
